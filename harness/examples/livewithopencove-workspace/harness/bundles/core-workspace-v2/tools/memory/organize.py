...
用法：
  ...
  python3 organize.py --dir <路径>   # 指定 output-layer 目录（默认 ./output/output-layer）
"""
...
# `时间戳-主题` 形如 20260520-192132-010051-quarterly-report
#                    20260520-103231-product-launch-plan
...
def main():
    ...
    base = args.dir or os.path.join(os.getcwd(), "output", "output-layer")
